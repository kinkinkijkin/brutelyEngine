...
brutelyMoveDupe(tmodIndex, 0.uint, vec3f(1.0, 1.0, -5.0))
brutelyTintDupe(tmodIndex, 0.uint, vec4f(0.1, 0.4, 0.4, 1.0))

brutelyMoveDupe(tmodIndex, tmodCopy1, vec3f(-3.0, -2.0, -7.0))
brutelyTintDupe(tmodIndex, tmodCopy1, vec4f(0.1, 0.4, 0.4, 1.0))
